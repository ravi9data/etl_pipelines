...
DAG_ID = 'monthly_load_v1_earned_revenue'
...
with DAG(
        ...
        schedule_interval=get_schedule('30 9 2 * *'),
        max_active_runs=1,
        catchup=False,
        tags=[DAG_ID, 'pipeline', 'finance', 'risk', 'commercial']) as dag:
    prev_task = None
    with TaskGroup('dwh_finance_monthly_earned_revenue',
                   prefix_group_id=False) as dwh_finance_monthly_earned_revenue:
    ...
    dwh_finance_monthly_earned_revenue
