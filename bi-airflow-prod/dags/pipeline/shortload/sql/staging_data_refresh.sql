...
select "number" 
from stg_api_production2.spree_orders where date(created_at)=current_date 
except 
select "number" 
from stg_api_production.spree_orders where date(created_at)=current_date ;
...
GRANT SELECT ON stg_api_production.spree_products TO hightouch_pricing;
GRANT SELECT ON stg_api_production.spree_variants TO hightouch_pricing;
GRANT SELECT ON stg_api_production.pictures TO hightouch_pricing;
GRANT SELECT ON stg_api_production.categories TO hightouch_pricing;
