...
GOOGLE_SHEET_ID = '1LE0zQg1xi23UqyfTAx8_K6x-cbKOrQc3T_gRoU8b2cs'
GOOGLE_SHEET_RANGE = 'sku_decision_to_sell_list'
REDSHIFT_CONN = 'redshift_default'
S3_BUCKET = 'grover-eu-central-1-production-data-bi-curated'
S3_DESTINATION_KEY = "google_sheets/sku_decision_to_sell_list.json"
...
dag = DAG(
    dag_id="sku_decision_to_sell_list",
    default_args=default_args,
    schedule_interval='00 09,13,17 * * 1-5',
    start_date=datetime.datetime(2021, 1, 1),
    catchup=False,
    tags=['gsheet', 'bi', 'sku_decision_to_sell_list'],
)
...
task_load_data_to_redshift = PythonOperator(
    ...
    op_kwargs={"s3_bucket": S3_BUCKET,
               ...
               "target_table": "sku_decision_to_sell_list",
               "target_schema": "staging_google_sheet"}
)
sku_decision_to_sell_list_sql = PostgresOperator(
    task_id="sku_decision_to_sell_list",
    postgres_conn_id=REDSHIFT_CONN,
    sql="./sql/sku_decision_to_sell_list.sql"
)
task_google_sheets_values_to_s3 >> task_load_data_to_redshift >> sku_decision_to_sell_list_sql
