...
GOOGLE_SHEET_ID = '1lAWZMLPzhbKx2jhv_ZsbCgzb_EbyaUlQ9luWLAQuSNU'
GOOGLE_SHEET_RANGE = 'Commission mapping'

REDSHIFT_CONN = 'redshift_default'
S3_BUCKET = 'grover-eu-central-1-production-data-bi-curated'
S3_DESTINATION_KEY = "google_sheets/marketing/affliates_commision_mapping.json"
...
dag = DAG(
    dag_id="affliates_commision_mapping",
    default_args=default_args,
    schedule_interval='0 17 * * *',
    start_date=datetime.datetime(2021, 1, 1),
    catchup=False,
    tags=['gsheet', 'marketing', 'bi'],
)
...
task_load_data_to_redshift = PythonOperator(
    ...
    op_kwargs={"s3_bucket": S3_BUCKET,
               ...
               "target_table": "affliates_commission_mapping",
