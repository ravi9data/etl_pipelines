...
GOOGLE_SHEET_ID = '1iVVERZO9uTQ3IR7h8SIa0xkhgr9BXUHJdq0s-7U_8EM'
GOOGLE_SHEET_RANGE = 'wemalo_softeon_sku_ean_list'

REDSHIFT_CONN = 'redshift_default'
S3_BUCKET = 'grover-eu-central-1-production-data-bi-curated'
S3_DESTINATION_KEY = "google_sheets/wemalo_softeon_sku_ean_list.json"
...
dag = DAG(
    dag_id="wemalo_softeon_sku_ean_list",
    default_args=default_args,
    schedule_interval='00 09 * * 1-5',
    start_date=datetime.datetime(2021, 1, 1),
    catchup=False,
    tags=['gsheet', 'bi', 'wemalo_softeon_sku_ean_list'],
)
...
task_load_data_to_redshift = PythonOperator(
    ...
    op_kwargs={"s3_bucket": S3_BUCKET,
               ...
               "target_table": "wemalo_softeon_sku_ean_list",
