...
GOOGLE_SHEET_ID = '1K6aePV8U_sEbG1wnO-h8H2qPbeEpui95-m_Oc_NuJWE'
GOOGLE_SHEET_RANGE = 'zipcodes'

REDSHIFT_CONN = 'redshift_default'
S3_BUCKET = 'grover-eu-central-1-production-data-bi-curated'
S3_DESTINATION_KEY = "google_sheets/supplier_zipcodes.json"
...
dag = DAG(
    dag_id="supplier_zipcodes",
    default_args=default_args,
    schedule_interval='0 10 * * 1-5',
    start_date=datetime.datetime(2021, 1, 1),
    catchup=False,
    tags=['gsheet', 'bi', 'supplier_zipcodes'],
)
...
task_load_data_to_redshift = PythonOperator(
    ...
    op_kwargs={"s3_bucket": S3_BUCKET,
               ...
               "target_table": "supplier_zipcodes",
