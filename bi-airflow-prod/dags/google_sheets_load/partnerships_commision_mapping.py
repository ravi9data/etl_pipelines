...
GOOGLE_SHEET_ID = '1enzB1VqnFQmw684zvFK7rD71F4pYTWyl3Qru3vq-Yao'
GOOGLE_SHEET_RANGE = 'commission_mapping'

REDSHIFT_CONN = 'redshift_default'
S3_BUCKET = 'grover-eu-central-1-production-data-bi-curated'
S3_DESTINATION_KEY = "google_sheets/marketing/partnerships_commision_mapping.json"
...
dag = DAG(
    dag_id="partnerships_commision_mapping",
    default_args=default_args,
    schedule_interval='0 17 * * *',
    start_date=datetime.datetime(2021, 1, 1),
    catchup=False,
    tags=['gsheet', 'bi', 'marketing'],
)
...
task_load_data_to_redshift = PythonOperator(
    ...
    op_kwargs={"s3_bucket": S3_BUCKET,
               ...
               "target_table": "partnerships_commission_mapping",
