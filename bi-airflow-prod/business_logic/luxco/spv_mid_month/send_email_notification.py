...
def send_email_notification(email_recipient, email_subject):
    ...
    email_message = """
                <html>
                    ...
                    <body>
                        <p>
                            Hello ! <br><br>
                            Luxco metrics from mid month execution: <br>
                                {luxco_metrics}<br><br>

                            Crawler data metrics - Daily:<br>
                                {crawler_data_metrics}<br><br>

                            Crawler data metrics - Monthly:<br>
                                {crawler_data_metrics_monthly}<br><br>
    ...
    luxco_metrics = extract_db_data(os.path.join(__location__, "sql/luxco_metrics.sql"))
    crawler_data_metrics = extract_db_data(os.path.join(__location__, "sql/crawler_data_metrics.sql"))      # noqa:E501
    crawler_data_metrics_monthly = extract_db_data(os.path.join(__location__, "sql/crawler_data_metrics_monthly.sql"))       # noqa:E501
    ...
    try:
        ...
        message.attach(MIMEText(email_message.format(luxco_metrics=luxco_metrics,
                                                     crawler_data_metrics=crawler_data_metrics,
                                                     crawler_data_metrics_monthly=crawler_data_metrics_monthly),        # noqa:E501
                                "html"))
