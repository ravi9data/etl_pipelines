DROP TABLE IF EXISTS dwh.shipment_reporting_monthly;
CREATE TABLE dwh.shipment_reporting_monthly as
...
select 
  ...
  DATEDIFF ( 'hour', a.refurbishment_start_at::timestamp, a.refurbishment_end_at::timestamp ) as time_to_finish_refurbishment
	from master.allocation a
	 left join (select allocation_id,first_delivery_attempt,failed_delivery_at from ods_operations.allocation_shipment) sm 
	...
	select 
		DATE_TRUNC('month',allocated_at) as fact_date,
		store_short,
		is_recirculated,
	...
	select 
		DATE_TRUNC('month',ready_to_ship_at) as fact_date,
		store_short,
		is_recirculated,
	...
	, shipped_detailed as (
	select 
		DATE_TRUNC('month',shipment_label_created_at) as fact_date,
		store_short,
		is_recirculated,
	...
	, fd_detailed as (
	select 
		DATE_TRUNC('month',failed_delivery_at) as fact_date,
		 store_short,
		is_recirculated,
	...
	select 
		DATE_TRUNC('month',revocation_date) as fact_date,
		store_short,
		is_recirculated,
	...
	select 
		DATE_TRUNC('month',delivered_at) as fact_date,
		store_short,
		is_recirculated,
	...
	select 
		DATE_TRUNC('month',return_shipment_label_created_at) as fact_date,
		store_short,
		is_recirculated,
	...
	select 
		DATE_TRUNC('month',return_shipment_at) as fact_date,
		store_short,
		is_recirculated,
	...
	select 
		DATE_TRUNC('month',return_delivery_date) as fact_date,
		store_short,
		is_recirculated,
	...
	select 
		DATE_TRUNC('month',refurbishment_start_at) as fact_date,
		store_short,
		is_recirculated,
	...
	select 
		DATE_TRUNC('month',refurbishment_end_at) as fact_date,
		store_short,
		is_recirculated,
...
GRANT SELECT ON dwh.shipment_reporting_monthly TO tableau;
