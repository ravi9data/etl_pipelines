drop table if exists dm_recommerce.recommerce_stages_financial;
create table dm_recommerce.recommerce_stages_financial as
...
GRANT SELECT ON dm_recommerce.recommerce_stages_financial TO tableau;