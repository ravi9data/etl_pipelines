drop table if exists dm_recommerce.return_stages_final;
create table dm_recommerce.return_stages_final as
with fact_dates as(
select dd.datum 
...
GRANT SELECT ON dm_recommerce.return_stages_final TO tableau;
