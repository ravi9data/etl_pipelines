drop table if exists dm_recommerce.recommerce_stages;
create table dm_recommerce.recommerce_stages as
...
from recommerce.ingram_micro_send_order_grading_status ii
left join yasemin_senlik.ingram_steps is_ on ii.status_code = is_.status_code and ii.disposition_code =is_.disposition_code
...
GRANT SELECT ON dm_recommerce.recommerce_stages TO tableau;
