...
create table if not exists dm_finance.spv_report_historical_snapshot (like
dm_finance.spv_report_historical);
alter table dm_finance.spv_report_historical_snapshot add snapshot_timestamp timestamp; */
INSERT INTO dm_finance.spv_report_historical_snapshot
SELECT
 *,
 CURRENT_TIMESTAMP AS snapshot_timestamp
FROM dm_finance.spv_report_historical
WHERE reporting_date = '2023-05-31'
;

GRANT SELECT ON dm_finance.spv_report_historical TO redash_pricing;
GRANT SELECT ON dm_finance.spv_report_historical TO hightouch_recommerce;
