...
DROP TABLE IF EXISTS ods_spv_historical.all_eu_crawler_m_zero_values_202407;
CREATE TABLE ods_spv_historical.all_eu_crawler_m_zero_values_202407 AS 
SELECT 
  1 AS code,
  m_since_as_good_as_new_price,
  agan_price_standardized,
  * 
FROM ods_spv_historical.price_per_condition_1
WHERE TRUE 
...
SELECT
  ...
  agan_price_standardized,
  *  
FROM ods_spv_historical.price_per_condition_2
WHERE TRUE 
  AND m_since_as_good_as_new_price = 0
...
DROP TABLE IF EXISTS ods_spv_historical.all_eu_prioritization_new_202407;
CREATE TABLE ods_spv_historical.all_eu_prioritization_new_202407 AS 
...
SELECT 
  ...
  * 
FROM 
ods_spv_historical.all_eu_crawler_m_zero_values_202407
)
SELECT *
...
DROP TABLE IF EXISTS ods_spv_historical.price_per_condition_202407_eu;
CREATE TABLE ods_spv_historical.price_per_condition_202407_eu AS 
SELECT 
  a.reporting_date,
  a.product_sku,
  a.neu_price,
...
FROM ods_spv_historical.price_per_condition_2 a
  LEFT JOIN ods_spv_historical.all_eu_prioritization_new_202407 b
