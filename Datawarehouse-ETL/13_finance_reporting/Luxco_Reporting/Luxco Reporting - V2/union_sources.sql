...
(
   ...
   WHERE
      reporting_month::date < '2024-08-01'::date
   UNION ALL
   SELECT distinct
      e.src,
      e.region,
...
DROP TABLE IF EXISTS ods_spv_historical.union_sources_202407_updated;
CREATE TABLE ods_spv_historical.union_sources_202407_updated as
with a as (
SELECT *,
   case 
...
DROP TABLE IF EXISTS ods_spv_historical.union_sources_202407_updated_2;
CREATE TABLE ods_spv_historical.union_sources_202407_updated_2 as
...
left join ods_spv_historical.union_sources_202407_updated  b
on a.product_sku = b.product_sku
...
SELECT *
FROM  ods_spv_historical.union_sources_202407_updated_2
...
DROP TABLE IF EXISTS ods_spv_historical.union_sources_202407_eu;
CREATE TABLE ods_spv_historical.union_sources_202407_eu as
SELECT
   *
FROM
...
DROP TABLE IF EXISTS ods_spv_historical.union_sources_202407_eu_all;
CREATE TABLE ods_spv_historical.union_sources_202407_eu_all as
SELECT
   *
FROM
   ods_spv_historical.tmp_union_sources
...
INSERT INTO
   ods_spv_historical.union_sources_202407_eu ( src, region, extract_date, reporting_month, item_id, product_sku, asset_condition, currency, price, price_in_euro)
   SELECT
      'MR' as src,
      'GERMANY' as region,
...
INSERT INTO
   ods_spv_historical.union_sources_202407_eu_all ( src, region, extract_date, reporting_month, item_id, product_sku, asset_condition, currency, price, price_in_euro)
   SELECT
      'MR' as src,
      'GERMANY' as region,
      luxco_month::date - 1 as extract_date,
...
DROP TABLE IF EXISTS ods_spv_historical.union_sources_202407_us; --Q
CREATE TABLE ods_spv_historical.union_sources_202407_us as
SELECT
   *
FROM
   ods_spv_historical.tmp_union_sources
...
insert into
   ods_spv_historical.union_sources_202407_us ( src, region, extract_date, reporting_month, item_id, product_sku, asset_condition, currency, price, price_in_euro)
   SELECT
      'MR' as src,
      'USA'as region,
      luxco_month::date - 1 as extract_date,
