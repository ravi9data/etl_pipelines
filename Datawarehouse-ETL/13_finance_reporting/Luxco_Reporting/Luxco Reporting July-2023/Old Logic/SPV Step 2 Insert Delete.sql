-- STEP 2
--Union Source of
drop table if exists ods_spv_historical.union_sources_202307;
create table ods_spv_historical.union_sources_202307 as
(
   select
      *
   from
...
drop table if exists ods_spv_historical.spv_used_asset_price_202307;
create table ods_spv_historical.spv_used_asset_price_202307 as
(
   select
      *
   from
      ods_spv_historical.spv_used_asset_price_202307_eu
   union all
   select
      *
   from
      ods_spv_historical.spv_used_asset_price_202307_us
)
;
delete
from
...
insert into
   ...
   select
      ...
      price_rank_month
   FROM
      ods_spv_historical.spv_used_asset_price_202307 ;
-- STEP 3
--Union Source of spv_used_asset_price_master_
drop table if exists ods_spv_historical.spv_used_asset_price_master_202307;
create table ods_spv_historical.spv_used_asset_price_master_202307 as
(
   select
      *
   from
      ods_spv_historical.spv_used_asset_price_master_202307_eu
   union all
   select
      *
   from
      ods_spv_historical.spv_used_asset_price_master_202307_us
)
;
delete
from
...
insert into
   ...
   select
      *
   from
      ods_spv_historical.spv_used_asset_price_master_202307;
-- STEP 4
--Union Source of price_per_condition_
drop table if exists ods_spv_historical.price_per_condition_202307;
create table ods_spv_historical.price_per_condition_202307 as
(
   select
      *
   from
...
insert into
   ...
   FROM
      ods_spv_historical.price_per_condition_202307;
-- Step 5
--Union Source of asset_market_value_
drop table if exists ods_spv_historical.asset_market_value_202307;
create table ods_spv_historical.asset_market_value_202307 as
(
   select
      *
   from
...
insert into
   ...
   FROM
      ods_spv_historical.asset_market_value_202307;
--Step 6
-- update mr prices in eu and us report master tables
update
   ods_production.spv_report_master_202307_eu
set
...
update
   ods_production.spv_report_master_202307_us
set
   final_price = lmr.final_price::double precision,
   m_since_last_valuation_price = 0
from
...
drop table if exists ods_production.spv_report_master_202307;
create table ods_production.spv_report_master_202307 as
(
   select
      *
   from
      ods_production.spv_report_master_202307_eu srme
   union all
   select
      *
   from
