...
WHERE
   date = '2023-07-31' ;
-------------------------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS ods_spv_historical.spv_report_master_202307;
CREATE TABLE ods_spv_historical.spv_report_master_202307 AS
SELECT
   *
FROM
   ods_production.spv_report_master_202307 ;
-------------------------------------------------------------------------------------------------------------------------------------
...
-------------------------------------LUXCO REPORTING----------------------------------------------------------------------------------------------
-------------------------------------LUXCO REPORTING----------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS ods_spv_historical.luxco_reporting_202307;
CREATE TABLE ods_spv_historical.luxco_reporting_202307 AS
(
...
(original_valuation / prev.previous_original_valuation) - 1
 ...
 , '[^[:alnum:][:blank:][:punct:]]', ''), ' ', ' ')
   ...
   FROM
      ods_spv_historical.spv_report_master_202307 spv
      LEFT JOIN
...
GRANT
SELECT
   ON ods_spv_historical.luxco_reporting_202307 to elene_tsintsadze;
GRANT
SELECT
   ON ods_spv_historical.luxco_reporting_202307 to paolo_giambona;
GRANT
SELECT
   ON ods_spv_historical.luxco_reporting_202307 TO accounting_redash;
