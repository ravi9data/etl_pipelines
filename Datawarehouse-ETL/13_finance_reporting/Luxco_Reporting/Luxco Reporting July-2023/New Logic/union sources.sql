...
DROP TABLE IF EXISTS ods_spv_historical_test.union_sources_202307_updated;
CREATE TABLE ods_spv_historical_test.union_sources_202307_updated as
with a as (
SELECT *,
   case 
...
DROP TABLE IF EXISTS ods_spv_historical_test.union_sources_202307_updated_2;
CREATE TABLE ods_spv_historical_test.union_sources_202307_updated_2 as
...
left join ods_spv_historical_test.union_sources_202307_updated  b
on a.product_sku = b.product_sku
...
SELECT *
FROM  ods_spv_historical_test.union_sources_202307_updated_2
...
DROP TABLE IF EXISTS ods_spv_historical_test.union_sources_202307_eu;
CREATE TABLE ods_spv_historical_test.union_sources_202307_eu as
SELECT
   *
FROM
...
DROP TABLE IF EXISTS ods_spv_historical_test.union_sources_202307_us; --Q
CREATE TABLE ods_spv_historical_test.union_sources_202307_us as
SELECT
   *
FROM
   ods_spv_historical_test.tmp_union_sources
...
insert into
   ods_spv_historical_test.union_sources_202307_us ( src, region, extract_date, reporting_month, item_id, product_sku, asset_condition, currency, price, price_in_euro)
   SELECT
      'MR' as src,
      'USA'as region,
      luxco_month::date - 1 as extract_date,
