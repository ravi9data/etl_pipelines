...
DROP TABLE IF EXISTS ods_spv_historical_test.spv_used_asset_price_202307_us;
create table ods_spv_historical_test.spv_used_asset_price_202307_us as with d as
(
   /*#############################################
...
------STEP 3---------
drop table if exists ods_spv_historical_test.spv_used_asset_price_master_202307_us;
---*************
create table ods_spv_historical_test.spv_used_asset_price_master_202307_us as ---*************
WITH a AS
(
   SELECT
   ...
   FROM
      ods_spv_historical_test.spv_used_asset_price_202307_us u		---*************
   WHERE
...
------STEP 4-----------------
DROP TABLE IF EXISTS ods_spv_historical_test.price_per_condition_202307_us;
---*************
create table ods_spv_historical_test.price_per_condition_202307_us AS    ---*************
WITH a AS
(
   SELECT DISTINCT
      b.product_sku,
   ...
   FROM
      ods_spv_historical_test.spv_used_asset_price_master_202307_us b		---*************
   where
...
-----STEP 5--------
drop table if exists ods_spv_historical_test.asset_market_value_202307_us;
---*************
create table ods_spv_historical_test.asset_market_value_202307_us as---*************
with d AS
(
   SELECT
      asset.asset_id,
...
------STEP 6--------
drop table if exists ods_spv_historical_test.spv_report_master_202307_us;
---*************
create table ods_spv_historical_test.spv_report_master_202307_us as---*************
SELECT distinct
   '2023-07-31'::date as reporting_date,
   a.asset_id,
   a.warehouse,
