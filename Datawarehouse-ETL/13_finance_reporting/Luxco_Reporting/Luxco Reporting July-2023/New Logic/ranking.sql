...
DROP TABLE IF EXISTS ods_spv_historical_test.all_eu_crawler_m_zero_values_202307;
CREATE TABLE ods_spv_historical_test.all_eu_crawler_m_zero_values_202307 AS 
SELECT 
  1 AS code,
...
SELECT
  ...
  agan_price_standardized,
  *  
FROM ods_spv_historical.price_per_condition_202307_eu
WHERE TRUE 
  AND m_since_as_good_as_new_price = 0
...
DROP TABLE IF EXISTS ods_spv_historical_test.all_eu_prioritization_new_202307;
CREATE TABLE ods_spv_historical_test.all_eu_prioritization_new_202307 AS 
...
SELECT 
  ...
  * 
FROM 
ods_spv_historical_test.all_eu_crawler_m_zero_values_202307
)
SELECT *
...
DROP TABLE IF EXISTS ods_spv_historical_test.price_per_condition_202307_eu;
CREATE TABLE ods_spv_historical_test.price_per_condition_202307_eu AS 
SELECT 
  a.reporting_date,
  a.product_sku,
  a.neu_price,
...
FROM ods_spv_historical.price_per_condition_202307_eu a
  LEFT JOIN ods_spv_historical_test.all_eu_prioritization_new_202307 b
