drop table if exists ods_spv_historical_test.asset_market_value_202307_eu;
---*************
create table ods_spv_historical_test.asset_market_value_202307_eu as---*************
with d AS
(
   SELECT
      asset.asset_id,
...
------STEP 6--------
drop table if exists ods_spv_historical_test.spv_report_master_202307_eu;
---*************
create table ods_spv_historical_test.spv_report_master_202307_eu as---*************
SELECT distinct
   '2023-07-31'::date as reporting_date,
   a.asset_id,
   a.warehouse,
