...
DROP TABLE IF EXISTS ods_spv_historical.spv_used_asset_price_202306_us;
create table ods_spv_historical.spv_used_asset_price_202306_us as with d as
(
   /*#############################################
...
order by
   3 desc ;
------STEP 3---------
drop table if exists ods_spv_historical.spv_used_asset_price_master_202306_us;
---*************
create table ods_spv_historical.spv_used_asset_price_master_202306_us as ---*************
WITH a AS
(
   SELECT
   ...
   FROM
      ods_spv_historical.spv_used_asset_price_202306_us u		---*************
   WHERE
...
------STEP 4-----------------
DROP TABLE IF EXISTS ods_spv_historical.price_per_condition_202306_us;
---*************
create table ods_spv_historical.price_per_condition_202306_us AS---*************
WITH a AS
(
   SELECT DISTINCT
      b.product_sku,
   ...
   FROM
      ods_spv_historical.spv_used_asset_price_master_202306_us b		---*************
   where
...
FROM
   a;
-----STEP 5--------
drop table if exists ods_spv_historical.asset_market_value_202306_us;
---*************
create table ods_spv_historical.asset_market_value_202306_us as---*************
with d AS
(
   SELECT
      asset.asset_id,
...
FROM
   f;
------STEP 6--------
drop table if exists ods_production.spv_report_master_202306_us;
---*************
create table ods_production.spv_report_master_202306_us as---*************
SELECT distinct
   '2023-06-30'::date as reporting_date,
   a.asset_id,
   a.warehouse,
