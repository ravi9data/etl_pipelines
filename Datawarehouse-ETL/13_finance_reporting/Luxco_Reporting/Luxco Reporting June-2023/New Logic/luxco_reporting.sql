...
WHERE
   date = '2023-06-30' ;
-------------------------------------------------------------------------------------------------------------------------------------
/*DROP TABLE IF EXISTS ods_spv_historical_test.spv_report_master_202306;
CREATE TABLE ods_spv_historical_test.spv_report_master_202306 AS
SELECT
   *
FROM
   ods_spv_historical_test.spv_report_master_202306 ;*/ --Not neccessary
-------------------------------------------------------------------------------------------------------------------------------------
...
-------------------------------------LUXCO REPORTING----------------------------------------------------------------------------------------------
-------------------------------------LUXCO REPORTING----------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS ods_spv_historical.luxco_reporting_202306_new;
CREATE TABLE ods_spv_historical.luxco_reporting_202306_new AS
(
...
(original_valuation / prev.previous_original_valuation) - 1
 ...
 , '[^[:alnum:][:blank:][:punct:]]', ''), ' ', ' ')
	...
	THEN 
     ...
     FROM
      ods_spv_historical_test.spv_report_master_202306 spv
      LEFT JOIN
