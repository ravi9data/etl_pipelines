...
DROP TABLE IF EXISTS ods_spv_historical.all_eu_crawler_m_zero_values_202306_new;
CREATE TABLE ods_spv_historical.all_eu_crawler_m_zero_values_202306_new AS 
SELECT 
  1 AS code,
  m_since_as_good_as_new_price,
  agan_price_standardized,
  * 
FROM ods_spv_historical_test.price_per_condition_1
WHERE TRUE 
...
SELECT
  ...
  agan_price_standardized,
  *  
FROM ods_spv_historical.price_per_condition_202306_eu
WHERE TRUE 
  AND m_since_as_good_as_new_price = 0
...
SELECT 
  ...
  agan_price_standardized,
  *  
FROM ods_spv_historical_test.price_per_condition_4
WHERE TRUE 
  AND m_since_as_good_as_new_price = 0
...
SELECT 
  ...
  agan_price_standardized,
  * 
FROM ods_spv_historical_test.price_per_condition_5
WHERE TRUE 
  AND m_since_as_good_as_new_price = 0
...
SELECT 
  ...
  agan_price_standardized,
  * 
FROM ods_spv_historical_test.price_per_condition_6
WHERE TRUE 
  AND m_since_as_good_as_new_price = 0
...
SELECT 
  ...
  agan_price_standardized,
  * 
FROM ods_spv_historical_test.price_per_condition_7
WHERE TRUE 
  AND m_since_as_good_as_new_price = 0
  UNION ALL 
...
SELECT 
  ...
  agan_price_standardized,
  * 
FROM ods_spv_historical_test.price_per_condition_8
WHERE TRUE 
  AND m_since_as_good_as_new_price = 0*/;
...
DROP TABLE IF EXISTS ods_spv_historical.all_eu_prioritization_new_202306_new;
CREATE TABLE ods_spv_historical.all_eu_prioritization_new_202306_new AS 
...
SELECT 
  ...
  * 
FROM 
ods_spv_historical.all_eu_crawler_m_zero_values_202306_new
)
SELECT *
...
DROP TABLE IF EXISTS ods_spv_historical.price_per_condition_202306_eu_new;
CREATE TABLE ods_spv_historical.price_per_condition_202306_eu_new AS 
SELECT 
  a.reporting_date,
  a.product_sku,
  a.neu_price,
...
FROM ods_spv_historical.price_per_condition_202306_eu a
  LEFT JOIN ods_spv_historical.all_eu_prioritization_new_202306_new b
    ON a.product_sku = b.product_sku
;

GRANT SELECT ON ods_spv_historical.price_per_condition_202306_eu_new TO tableau;
