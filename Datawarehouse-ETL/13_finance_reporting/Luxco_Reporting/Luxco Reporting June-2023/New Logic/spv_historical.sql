DROP TABLE IF EXISTS ods_spv_historical_test.spv_report_historical;
CREATE TABLE ods_spv_historical_test.spv_report_historical AS
...
SELECT DISTINCT
 ...
 s.rental_period, 
 m.warehouse
FROM ods_spv_historical_test.spv_report_master m
...
/* Historization for current month data
create table if not exists ods_spv_historical_test.spv_report_historical_snapshot (like
ods_spv_historical_test.spv_report_historical);
alter table ods_spv_historical_test.spv_report_historical_snapshot add snapshot_timestamp timestamp; */
INSERT INTO ods_spv_historical_test.spv_report_historical_snapshot
SELECT
 *,
 CURRENT_TIMESTAMP AS snapshot_timestamp
FROM ods_spv_historical_test.spv_report_historical
WHERE reporting_date = '2023-06-30'
;