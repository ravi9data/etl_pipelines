...
drop table if exists ods_spv_historical.asset_market_value_202306_eu_new;
---*************
create table ods_spv_historical.asset_market_value_202306_eu_new as---*************
with d AS
(
   SELECT
      asset.asset_id,
...
------STEP 6--------
drop table if exists ods_spv_historical.spv_report_master_202306_eu_new;
---*************
create table ods_spv_historical.spv_report_master_202306_eu_new as---*************
SELECT distinct
   '2023-06-30'::date as reporting_date,
   a.asset_id,
   a.warehouse,
