drop table if exists   dm_commercial.pricing_spv_used_asset_price_master; 
create table dm_commercial.pricing_spv_used_asset_price_master as
WITH a AS (    
        SELECT 
           ...
           FROM  dm_commercial.pricing_outlier_removal u
