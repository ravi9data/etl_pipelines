DROP TABLE IF EXISTS web.sessions_snowplow;
CREATE TABLE web.sessions_snowplow
  DISTKEY(session_id)
  SORTKEY(session_id)
AS 
WITH prep AS (
...
sums AS (
  ...
  WHERE b.session_start::date>'2019-06-01' AND a.page_view_in_session_index = 1)
...
GRANT SELECT ON web.sessions_snowplow TO tableau;
