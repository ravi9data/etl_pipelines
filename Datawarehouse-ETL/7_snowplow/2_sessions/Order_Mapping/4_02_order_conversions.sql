DROP TABLE IF EXISTS web.order_conversions_snowplow;
CREATE TABLE web.order_conversions_snowplow AS 
...
GRANT SELECT ON web.order_conversions_snowplow TO tableau;
