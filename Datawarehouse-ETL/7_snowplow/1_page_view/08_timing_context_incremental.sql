---web_page_context
create temp table web_timing_context_dl (like scratch.web_timing_context); 

insert into web_timing_context_dl 
  WITH prep AS (
    ...
    and pt.root_tstamp > DATEADD(week, -1, CURRENT_DATE)
  ), rolledup AS (
...
delete from scratch.web_timing_context 
using web_timing_context_dl  s
where scratch.web_timing_context.page_view_id = s.page_view_id; 



insert into scratch.web_timing_context 
select * from web_timing_context_dl ;

end transaction;


drop table web_timing_context_dl ;