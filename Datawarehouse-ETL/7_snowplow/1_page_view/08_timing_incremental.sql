DROP TABLE IF EXISTS scratch.web_timing_context_incremental;
CREATE TABLE scratch.web_timing_context_incremental
...
AS (
  ...
  WITH prep AS (
    ...
    and pt.root_tstamp > DATEADD(day, -3, CURRENT_DATE)
  ), rolledup AS (
