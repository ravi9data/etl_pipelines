create table web.web_vitals as
with slug as (
...
page as(
select event_id,  collector_tstamp ,domain_sessionid , page_url::varchar(5000),dvce_type,platform, page_urlpath ,
...
where etl_tstamp::date > '2020-08-10' and se_category ='web_vitals' and page_url not like '%localhost%'
...
case 
  ...
  left join slug on slug.slug=url_split3
	...
	where collector_tstamp::date > '2020-08-10';
