drop table if exists web.product_info_from_imp;
CREATE table web.product_info_from_imp as(
select a.*, b."action",
ev.user_id,
ev.domain_userid,
ev.domain_sessionid,
...
ev.os_name,
ev.page_url
from atomic.com_google_analytics_enhanced_ecommerce_impression_field_object_1 as a
