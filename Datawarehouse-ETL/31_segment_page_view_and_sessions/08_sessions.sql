DROP TABLE IF EXISTS segment.sessions_web;
CREATE TABLE segment.sessions_web
    DISTKEY(session_id)
...
GRANT SELECT ON segment.sessions_web TO tableau;
GRANT SELECT ON segment.sessions_web TO hams;
