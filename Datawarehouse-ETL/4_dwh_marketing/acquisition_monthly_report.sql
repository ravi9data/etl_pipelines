DROP TABLE IF EXISTS dwh.acquisition_monthly_report ;
CREATE TABLE dwh.acquisition_monthly_report AS 
WITH pv AS (
	SELECT 
		session_id,
...
,a AS (
	SELECT 
		DATE_TRUNC('month', s.session_start)::date AS fact_date,
...
,b AS (
	SELECT  
		DATE_TRUNC('month',o.created_date)::date AS fact_Date,
...
GRANT SELECT ON dwh.acquisition_monthly_report TO tableau;
