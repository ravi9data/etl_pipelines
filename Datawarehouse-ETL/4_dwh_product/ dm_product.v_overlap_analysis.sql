-- marcel_weber.v_conse_smartphone_cohort source

CREATE OR REPLACE VIEW dm_product.v_conse_smartphone_cohort AS
WITH valid_subs AS (
SELECT DISTINCT
	s.customer_id, 
	s.subscription_id, 
...
GRANT SELECT ON dm_product.v_conse_smartphone_cohort TO tableau;