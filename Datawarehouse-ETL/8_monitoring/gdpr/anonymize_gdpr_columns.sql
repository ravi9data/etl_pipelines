...
inner join ods_data_sensitive.pii_deleted_users_delta pii  on t.customer_id = pii.customer_id;
*/
------------------------------------------------------------------------------------------
/*
Schema: Master
...
inner join ods_data_sensitive.pii_deleted_users_delta pii  on sc.customer_id = pii.customer_id;
*/
------------------------------------------------------------------------------------------
/*
...
inner join ods_data_sensitive.pii_deleted_users_delta pii  on oo.customer_email__c = pii.customer_email;*/
...
inner join ods_data_sensitive.pii_deleted_users_delta pii  on t.user_id = pii.customer_email;*/
...
inner join ods_data_sensitive.pii_deleted_users_delta pii  on emp.email = pii.customer_email;*/
...
inner join ods_data_sensitive.pii_deleted_users_delta pii  on pf.email = pii.customer_email;*/
...
inner join ods_data_sensitive.pii_deleted_users_delta pii  on t.user_id=pii.customer_id;
...
inner join ods_data_sensitive.pii_deleted_users_delta pii  on wle.email = pii.customer_email;*/
...
inner join ods_data_sensitive.pii_deleted_users_delta pii  on t.external_user_id = pii.customer_id;
...
inner join ods_data_sensitive.pii_deleted_users_delta pii  on SUBSTRING(t.customer,20,6) = pii.customer_id;
...
inner join ods_data_sensitive.pii_deleted_users_delta pii  on t.external_id = pii.customer_id;
...
inner join ods_data_sensitive.pii_deleted_users_delta pii  on t.spree_customer_id__c = pii.customer_id;
...
inner join ods_data_sensitive.pii_deleted_users_delta pii  on sf.spree_customer_id__c = pii.customer_id;
...
inner join ods_data_sensitive.pii_deleted_users_delta pii  on sf.id = pii.customer_email;
...
inner join ods_data_sensitive.pii_deleted_users_delta pii  on sf.customer_email__c = pii.customer_email;
...
inner join ods_data_sensitive.pii_deleted_users_delta pii  on t.customer_id_mapped = pii.customer_id;
