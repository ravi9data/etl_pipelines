-- "atomic".com_google_analytics_enhanced_ecommerce_impression_field_object_1 definition
-- Drop table

-- DROP TABLE "atomic".com_google_analytics_enhanced_ecommerce_impression_field_object_1;

--DROP TABLE atomic.com_google_analytics_enhanced_ecommerce_impression_field_object_1;
CREATE TABLE IF NOT EXISTS atomic.com_google_analytics_enhanced_ecommerce_impression_field_object_1
(
...
;
ALTER TABLE atomic.com_google_analytics_enhanced_ecommerce_impression_field_object_1 owner to snowplow;


-- "atomic".com_google_analytics_enhanced_ecommerce_impression_field_object_1 foreign keys

ALTER TABLE "atomic".com_google_analytics_enhanced_ecommerce_impression_field_object_1 ADD CONSTRAINT com_google_analytics_enhanced_ecommerce_impression_field_object_1_root_id_fkey FOREIGN KEY (root_id) REFERENCES events(event_id);
