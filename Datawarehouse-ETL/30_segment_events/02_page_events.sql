...
DROP TABLE IF EXISTS segment.page_events;
CREATE TABLE segment.page_events 
DISTKEY(session_id)
...
GRANT SELECT ON segment.page_events TO tableau;
GRANT SELECT ON segment.page_events TO hams;
