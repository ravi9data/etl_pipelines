...
CREATE TEMP TABLE tmp_segment_identify_events AS
...
DELETE FROM segment.identify_events 
USING tmp_segment_identify_events tmp
WHERE identify_events.event_id = tmp.event_id;

INSERT INTO segment.identify_events
SELECT *
FROM tmp_segment_identify_events;
