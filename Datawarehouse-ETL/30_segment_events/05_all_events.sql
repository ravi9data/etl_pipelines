DROP TABLE IF EXISTS segment.all_events;
CREATE TABLE segment.all_events
DISTKEY(session_id)
...
GRANT SELECT ON segment.all_events TO tableau;
GRANT SELECT ON segment.all_events TO hams;