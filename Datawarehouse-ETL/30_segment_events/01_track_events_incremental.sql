...
CREATE TEMP TABLE tmp_segment_track_events AS
WITH track_data AS (
SELECT
    anonymous_id,
    userid,
...
DELETE FROM segment.track_events 
USING tmp_segment_track_events tmp
WHERE track_events.event_id = tmp.event_id;

INSERT INTO segment.track_events
SELECT *
FROM tmp_segment_track_events;
