...
DAG_ID = "sub_cancellation_forecasting_netherlands"
...
def cancellation_forecasting_netherlands():
...
dag = DAG(
    ...
    schedule_interval=get_schedule("10 6 1 * *"),
    max_active_runs=1,
    catchup=False,
    tags=["Automation", "DS"]
)
...
cancellation_forecasting_netherlands = PythonOperator(
    dag=dag,
    task_id="cancellation_forecasting_netherlands",
    python_callable=cancellation_forecasting_netherlands,
    executor_config={
        "KubernetesExecutor": {
...
t0 >> cancellation_forecasting_netherlands
