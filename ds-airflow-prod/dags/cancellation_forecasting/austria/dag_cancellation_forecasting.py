...
DAG_ID = "sub_cancellation_forecasting_austria"
...
def cancellation_forecasting_austria():
...
dag = DAG(
    ...
    schedule_interval=get_schedule("15 6 1 * *"),
    max_active_runs=1,
    catchup=False,
    tags=["Automation", "DS"]
)
...
cancellation_forecasting_austria = PythonOperator(
    dag=dag,
    task_id="cancellation_forecasting_austria",
    python_callable=cancellation_forecasting_austria,
    executor_config={
        "KubernetesExecutor": {
...
t0 >> cancellation_forecasting_austria
