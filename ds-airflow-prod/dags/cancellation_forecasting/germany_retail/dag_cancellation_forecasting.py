...
DAG_ID = "sub_cancellation_forecasting_germany_retail"
...
def cancellation_forecasting_germany_retail():
...
dag = DAG(
    ...
    schedule_interval=get_schedule("25 6 1 * *"),
    max_active_runs=1,
    catchup=False,
    tags=["Automation", "DS"]
)
...
cancellation_forecasting_germany_retail = PythonOperator(
    dag=dag,
    task_id="cancellation_forecasting_germany_retail",
    python_callable=cancellation_forecasting_germany_retail,
    executor_config={
        "KubernetesExecutor": {
...
t0 >> cancellation_forecasting_germany_retail
