...
DAG_ID = "sub_cancellation_forecasting_germany_b2b"
...
def cancellation_forecasting_germany_b2b():
...
dag = DAG(
    ...
    schedule_interval=get_schedule("5 6 1 * *"),
    max_active_runs=1,
    catchup=False,
    tags=["Automation", "DS"]
)
...
cancellation_forecasting_germany_b2b = PythonOperator(
    dag=dag,
    task_id="cancellation_forecasting_germany_b2b",
    python_callable=cancellation_forecasting_germany_b2b,
    executor_config={
        "KubernetesExecutor": {
...
t0 >> cancellation_forecasting_germany_b2b
