...
DAG_ID = "sub_cancellation_forecasting_spain"
...
def cancellation_forecasting_spain():
...
dag = DAG(
    ...
    schedule_interval=get_schedule("20 6 1 * *"),
    max_active_runs=1,
    catchup=False,
    tags=["Automation", "DS"]
)
...
cancellation_forecasting_spain = PythonOperator(
    dag=dag,
    task_id="cancellation_forecasting_spain",
    python_callable=cancellation_forecasting_spain,
    executor_config={
        "KubernetesExecutor": {
...
t0 >> cancellation_forecasting_spain
