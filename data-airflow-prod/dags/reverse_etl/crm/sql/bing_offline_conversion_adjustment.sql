WITH submitted_orders AS (
     ...
     get_non_paid_last_touch_gclid AS (
         SELECT DISTINCT 
            ...
            CASE WHEN store_country = 'United States' THEN 'USD' ELSE 'EUR' END AS "adjustment currency",
            CAST(DATE_ADD('hour', 16, submitted_date::timestamp(0)) AS VARCHAR) || '+1000' AS "adjustment time",
