...
from business_logic.reverse_etl.braze.custom_attributes.custom_attributes import (
    export_redshift_data_to_s3, get_delta_records, send_records_to_braze)
from plugins.dag_utils import get_schedule, on_failure_callback

DAG_ID = 'braze_custom_attributes_export'
...
default_args = {
    ...
    'start_date': datetime.datetime(2022, 4, 25),
    'retries': 2,
...
dag = DAG(
    ...
    description='Export user data from Redshift and send to Braze',
    schedule_interval=get_schedule('*/60 * * * *'),
    max_active_runs=1,
    catchup=False,
