DROP TABLE IF EXISTS staging_price_collection.amazon_us_copy_s3;
CREATE TABLE IF NOT EXISTS staging_price_collection.amazon_us_copy_s3
(
...
CREATE TABLE IF NOT EXISTS staging_price_collection.amazon_us
(
	item_id VARCHAR(200)   ENCODE RAW
	,product_name VARCHAR(2000)   ENCODE RAW
	,brand VARCHAR(65000)   ENCODE RAW
