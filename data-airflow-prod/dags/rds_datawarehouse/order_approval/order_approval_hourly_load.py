...
from dags.rds_datawarehouse.order_approval.config.hourly_load import config
from plugins.dag_utils import get_schedule, on_failure_callback
from plugins.operators.s3.db_to_s3_operator import DbToS3Operator

DAG_ID = 'order_approval_hourly_load'
...
dag = DAG(
    ...
    description='Incremental load order_approval data from RDS dwh replica to data lake',
    schedule_interval=get_schedule('20 11,23 * * *'),
    catchup=False,
    max_active_runs=1,
