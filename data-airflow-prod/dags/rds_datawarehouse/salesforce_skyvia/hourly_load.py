...
from dags.rds_datawarehouse.salesforce_skyvia.config.hourly_load import config
from plugins.dag_utils import get_schedule, on_failure_callback
from plugins.operators.s3.db_to_s3_operator import DbToS3Operator

DAG_ID = 'salesforce_skyvia_hourly_load'
...
dag = DAG(
    ...
    schedule_interval=get_schedule('50 8,10 * * *'),
    catchup=False,
    max_active_runs=1,
    tags=[DAG_ID, 'saleforce_skyvia', 'daily', 'rds', 'postgres', 'datawarehouse']
)
