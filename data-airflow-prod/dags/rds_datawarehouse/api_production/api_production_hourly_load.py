...
from dags.rds_datawarehouse.api_production.config.hourly_load import config
from plugins.dag_utils import get_schedule, on_failure_callback
from plugins.operators.s3.db_to_s3_operator import DbToS3Operator

DAG_ID = 'api_production_hourly_load'
...
dag = DAG(
    ...
    description='DAG for api_production hourly loads from RDS datawarehouse to datalake',
    schedule_interval=get_schedule('0 10,23 * * *'),
    catchup=False,
    max_active_runs=1,
