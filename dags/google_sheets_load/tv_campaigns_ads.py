...
GOOGLE_SHEET_ID = '1d063yGHkIVG6a1uir5SsQelIryqgABSGhIYsEzz8Wb0'
GOOGLE_SHEET_RANGE = 'tv_ads_data'

REDSHIFT_CONN = 'redshift_default'
S3_BUCKET = 'grover-eu-central-1-production-data-bi-curated'
S3_DESTINATION_KEY = "google_sheets/tv_campaigns_ads.json"
...
dag = DAG(
    dag_id="tv_campaigns_ads",
    default_args=default_args,
    schedule_interval='0 10 * * 1-5',
    start_date=datetime.datetime(2021, 1, 1),
    catchup=False,
    tags=['gsheet', 'bi', 'tv_campaigns_ads'],
)
