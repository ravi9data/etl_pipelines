...
GOOGLE_SHEET_ID = '1JQx-a9OwUPwUJI6GM9MuI8uEi5DRO7LrntC9TuOmDqI'
GOOGLE_SHEET_RANGE = 'Combined'

REDSHIFT_CONN = 'redshift_default'
S3_BUCKET = 'grover-eu-central-1-production-data-bi-curated'
S3_DESTINATION_KEY = "google_sheets/product_family_check_combined.json"
...
dag = DAG(
    dag_id="product_family_check_combined",
    default_args=default_args,
    schedule_interval='0 10 * * 1-5',
    start_date=datetime.datetime(2021, 1, 1),
    catchup=False,
    tags=['gsheet', 'bi', 'product_family_check'],
)
...
task_load_data_to_redshift = PythonOperator(
    ...
    op_kwargs={"s3_bucket": S3_BUCKET,
               ...
               "target_table": "product_family_check_combined",
