...
GOOGLE_SHEET_ID = '1Pwr92bGd_GwAqM217rN-a7ec7gtaRz9CduPagdcPD0I'
GOOGLE_SHEET_RANGE = 'GDPR Input'

REDSHIFT_CONN = 'redshift_default'
S3_BUCKET = 'grover-eu-central-1-production-data-bi-curated'
S3_DESTINATION_KEY = "google_sheets/gdpr_input.json"
