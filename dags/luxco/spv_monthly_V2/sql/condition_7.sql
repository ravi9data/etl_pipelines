  --Union source - Condition Seven

DROP TABLE IF EXISTS ods_spv_historical.union_sources_7;
CREATE TABLE ods_spv_historical.union_sources_7 as
SELECT
   *
FROM
...
DROP TABLE IF EXISTS ods_spv_historical.spv_used_asset_price_7;
create table ods_spv_historical.spv_used_asset_price_7 as with d as
(
   /*#############################################
...
###################################################*/
   select DISTINCT
      ...
      mm.avg_mm_price
   from
      ods_spv_historical.union_sources_7 s		---*************
      left join
         d mm
...
----------------------------------------------------------
----------------------------------------------------------
drop table if exists ods_spv_historical.spv_used_asset_price_master_7;
---*************
create table ods_spv_historical.spv_used_asset_price_master_7 as ---*************
WITH a AS
(
   SELECT
   ...
   FROM
      ods_spv_historical.spv_used_asset_price_7 u		---*************
   WHERE
...
DROP TABLE IF EXISTS ods_spv_historical.price_per_condition_7;
---*************
create table ods_spv_historical.price_per_condition_7 AS---*************
WITH a AS
(
   SELECT DISTINCT
      b.product_sku,
   ...
   FROM
      ods_spv_historical.spv_used_asset_price_master_7 b		---*************
   where
