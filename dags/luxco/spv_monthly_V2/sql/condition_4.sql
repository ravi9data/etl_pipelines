--Union source - Condition Four

DROP TABLE IF EXISTS ods_spv_historical.union_sources_4;
CREATE TABLE ods_spv_historical.union_sources_4 as
SELECT
   *
FROM
...
DROP TABLE IF EXISTS ods_spv_historical.spv_used_asset_price_4;
create table ods_spv_historical.spv_used_asset_price_4 as with d as
(
   /*#############################################
...
###################################################*/
   select DISTINCT
      ...
      mm.avg_mm_price
   from
      ods_spv_historical.union_sources_4 s		---*************
      left join
         d mm
...
----------------------------------------------------------
----------------------------------------------------------
drop table if exists ods_spv_historical.spv_used_asset_price_master_4;
---*************
create table ods_spv_historical.spv_used_asset_price_master_4 as ---*************
WITH a AS
(
   SELECT
   ...
   FROM
      ods_spv_historical.spv_used_asset_price_4 u		---*************
   WHERE
...
DROP TABLE IF EXISTS ods_spv_historical.price_per_condition_4;
---*************
create table ods_spv_historical.price_per_condition_4 AS---*************
WITH a AS
(
   SELECT DISTINCT
      b.product_sku,
   ...
   FROM
      ods_spv_historical.spv_used_asset_price_master_4 b		---*************
   where
